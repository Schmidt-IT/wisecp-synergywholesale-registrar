...
class SynergyWholesale_API
{
    ...
    function synergywholesaledomains_SaveNameservers(array $params)
    {
        $request = [
            'dnsConfigType' => 1,
            'nameServers' => $this->synergywholesaledomains_helper_getNameservers($params),
        ];
    ...
    {
        return $this->$this->synergywholesaledomains_apiRequest('domainReleaseUK', $params, [
    ...
    function synergywholesaledomains_RegisterDomain(array $params)
    {
        ...
        if (preg_match('/\.?au$/', $params['tld'])) {
            ...
            list(,, $brn) = $matches;
            if ($this->synergywholesaledomains_validateAUState($brn)) {
                $brn .= ' BN';
            }
    ...
    function synergywholesaledomains_IDProtectToggle(array $params)
    {
        ...
        return $this->synergywholesaledomains_apiRequest($command, $params, [], false);
    }
    ...
    function synergywholesaledomains_RenewDomain(array $params)
    {
        ...
        return $this->synergywholesaledomains_apiRequest('renewDomain', $params, $request, false);
    }
    ...
    function synergywholesaledomains_SaveContactDetails(array $params)
    {
        ...
        foreach ($contactTypes as $contactType => $whmcs_contact) {
            ...
            $request["{$contactType}_phone"] = $this->synergywholesaledomains_formatPhoneNumber(
    ...
    {
        $idProtectStatus = $this->synergywholesaledomains_apiRequest('domainInfo', $params, [], false);
        $command = ('Enabled' === $idProtectStatus['idProtect'] ? 'listProtectedContacts' : 'listContacts');
        $contacts = $this->synergywholesaledomains_apiRequest($command, $params, [], false);
        $response = [];
    ...
    function synergywholesaledomains_manageDNSSEC(array $params)
    {
        ...
        if (isset($_REQUEST['sub'])) {
            switch ($_REQUEST['sub']) {
                case 'save':
                    try {
                        $save = $this->synergywholesaledomains_apiRequest('DNSSECAddDS', $params, [
        ...
        try {
            $vars['records'] = [];
            $response = $this->synergywholesaledomains_apiRequest('DNSSECListDS', $params);
    ...
    {
        return $this->synergywholesaledomains_apiRequest('addSimpleURLForward', $params, [
    ...
    {
        return $this->synergywholesaledomains_apiRequest('deleteSimpleURLForward', $params, [
    ...
    function synergywholesaledomains_manageDNSURLForwarding(array $params)
    {
        ...
        if (isset($_REQUEST['op'])) {
            switch ($_REQUEST['op']) {
                ...
                case 'addRecord':
                    $nameservers = $this->synergywholesaledomains_getNameservers($params, true);
                    ...
                    $domain = $this->synergywholesaledomains_helper_getDomain($params);
                    ...
                    if (empty($_REQUEST['hostname'])) {
                        ...
                        $record['hostname'] = $this->synergywholesaledomains_helper_getDomain($params);
                    } else {
    ...
    function synergywholesaledomains_custom_GetDNS(array $params)
    {
        ...
        try {
            ...
            if (!empty($dns['records'])) {
                 ...
                 */
                $hostNameRegex = '/(?:\.' . $this->synergywholesaledomains_helper_getDomain($params) . '\s*)$/m';
